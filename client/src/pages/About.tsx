...
const stats = [
  ...
  { icon: HiOutlineScissors, value: '40+', label: 'Моделей каждый месяц' },
          ...
          <div className="grid md:grid-cols-[auto_1fr] gap-8 items-start">
            ...
            <div>
              ...
              <p className="text-[#6B6B6B] leading-relaxed">
                ...
                нам ежемесячно выпускать около 40 моделей и отшивать более 2000 единиц в неделю.
